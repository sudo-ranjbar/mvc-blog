            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo URLROOT; ?>/articles/add" method="post">
                        ...
                        <div class="form-group">
                            <label for="body"> متن مقاله <sup>*</sup> </label>
                            <textarea type="body" name="body" class="form-control <?php echo (!empty($data['body_err'])) ? 'is-invalid' : ''; ?>"> <?php echo $data['body']; ?> </textarea>
